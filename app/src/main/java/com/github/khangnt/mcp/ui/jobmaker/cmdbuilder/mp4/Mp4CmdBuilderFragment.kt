...
class Mp4CmdBuilderFragment : CommandBuilderFragment() {
    ...
    companion object {
        ...
        private val mp4VideoQuality = arrayOf("2", "6", "12", "18", "26")
    }
    ...
    override fun validateConfig(onSuccess: (CommandConfig) -> Unit) {
        onSuccess(
            Mp4CmdConfig(inputFileUris, mp4VideoQuality[spinnerVideoQuality.selectedItemPosition])
        )
    }
}

class Mp4CmdConfig(inputFiles: List<String>, private val videoQuality: String) :
    ...
    override fun makeJobs(finalFinalOutputs: List<FinalOutput>): List<Job> {
        ...
        val cmdArgs =
            StringBuffer("-hide_banner -map_metadata 0:g ")
