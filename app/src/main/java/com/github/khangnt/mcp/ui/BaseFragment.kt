...
abstract class BaseFragment : RxFragment() {
    ...
    /**
     * If this fragment is attached to a [BaseActivity], then this callback will be triggered when
     * the back button is pressed. If multiple BaseFragments are visible in a single activity, there
     * is no guarantee on which fragment will get the callback first.
     *
