...
public class FabMenu extends FloatingActionButton implements View.OnClickListener {
  ...
  public void addChild(
      @DrawableRes int icon, OnClickListener onClickListener, @StringRes int label) {
    addChild(icon, onClickListener, getResources().getString(label));
  }

  private FloatingActionButton buildChild(
      @DrawableRes int icon, final OnClickListener onClickListener, String label) {
    ...
    if (getParent() instanceof CoordinatorLayout) {
      ...
      params.bottomMargin =
          (int)
              (SIZE_L_DP * dpScale
                  + 4 * dpScale
                  + padding * (2 + labels.size())
                  + SIZE_S_DP * dpScale * labels.size());
  ...
  public static class MenuItem {
    ...
    public MenuItem(
        @DrawableRes int iconRes, OnClickListener onClickListener, @StringRes int labelRes) {
    ...
    public MenuItem(@DrawableRes int iconRes, OnClickListener onClickListener, String label) {
      this.iconRes = iconRes;
      this.label = label;
      this.onClickListener = onClickListener;
      labelRes = 0;
  ...
  public static class Behavior extends FloatingActionButton.Behavior {
    ...
    private void updateFabTranslationForSnackbar(
        CoordinatorLayout parent, FloatingActionButton fab, View snackbar) {
